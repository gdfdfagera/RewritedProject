...
public class ConnectionUtilUsers {
    ...
    public User chekUser (Connection conn,String recovery, String username, String password, double balance) throws SQLException{
        Statement statement;
        User t = new User();
        try {
            ...
            while (result.next()) {
                ...
                if (userName.equals(username) && pass.equals(password) && bal == balance){
